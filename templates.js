export const templates = [
  ...
  },
  {
    ...
    defaults: {
      ...
      bgColor: '#ffffff',
      textColor: '#ffffff',
      content: 'আজকের আজাইরা সব খবর, এক নজরে দেখে নিন।',
      author: 'ড. হানিয়া আমির',
      designation: 'বিশ্বখ্যাত সুন্দরী',
